...
const MarketingSidebar = () => {
  ...
  const menuItems = [
    { name: 'Dashboard', icon: FaTachometerAlt, path: '/marketingManagerDashboard' },
    { name: 'My Profile', icon: FaUser, path: '/marketingManagerProfile' },
    { name: 'Service Providers', icon: FaUsers, path: '/serviceProviders' },
    // { name: 'Learning Paths', icon: FaBook, path: '/admin/learning-paths' },
    { name: 'Advertisements', icon: FaBullhorn, path: '/advertisements' },
    { name: 'Email', icon: FaEnvelope, path: '/marketing/email' },
