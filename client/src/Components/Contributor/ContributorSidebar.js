...
const ContributorSideBar = () => {
  ...
  const menuItems = [
    { name: 'Dashboard', icon: FaTachometerAlt, path: '/contributor/dashboard' },
    { name: 'My Profile', icon: FaUser, path: '/contributor/profile' },
    { name: 'My Resources', icon: FaBook, path: '/resources' },
