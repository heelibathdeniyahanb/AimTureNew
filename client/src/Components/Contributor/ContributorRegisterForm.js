 ...
 const [success]=useState('');
  ...
  return (
    <div className={`flex min-h-screen justify-center items-center `}>
      ...
      >
        <h2 className={`text-3xl font-semibold text-center mb-6 text-[#F0F4F8]`}>Sign up as an Content Provider</h2> 
...
export default ContributorRegisterForm;
